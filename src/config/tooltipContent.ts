...
export const TOOLTIP_CONTENT = {
  ...
  chatbot: {
    ...
    systemPromptTokens: 
      "The base instructions that define your chatbot's behavior and knowledge. Sent with every conversation turn.",
    
    avgUserMessageTokens: 
      "Typical length of user questions or messages. ~4 characters = 1 token, ~1.3 tokens per word.",
    
    avgResponseTokens: 
      "Typical length of chatbot responses. Longer responses cost more due to higher output token pricing.",
    ...
    contextStrategy: 
      "How much conversation history is included in each turn. Minimal saves cost, Full improves response quality.",
  ...
  prompt: {
    ...
    promptInput: 
      "Enter your prompt text. Character and token counts update in real-time to help estimate costs.",
    
    responsePreset: 
      "Estimated length of the model's response. Output tokens are typically 3-4x more expensive than input tokens.",
    ...
    contextStrategy: 
      "How much conversation history is retained per turn. Affects response quality and token consumption.",
